...
# change the header of bot to look like a browser
    def start_requests(self):
        ...
        for i in range(1, 508): # Change the range to the page numbers. more improvement can be done
    ...
    def parse(self, response):
        ...
        for box in boxes:
            ...
            l.add_css('employee', 'div.list-item.custom_popover:nth-child(3) span)
            l.add_css('location', 'div.list-item.custom_popover:nth-child(4) span)
